...
import logoMed from '../../logos/logoMed.svg';
import logoMH from '../../logos/logoMH.svg';
...
function Home() {
  ...
  return (
    <div id="home">
      ...
      <ul id="home--options">
        <Link className="home--box home--box-link" to="/step1">
          <li>
        ...
        <Link className="home--box home--box-link" to="/mental">
          <li>
